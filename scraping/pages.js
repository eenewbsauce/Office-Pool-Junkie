        ...
        return new Promise((resolve, reject) => {
            request({
                ...
                rows.each((i, el) => {
                    ...
                    matchups.push({
                        away: {
                            name: cells.eq(1).find('.col-6.text-nowrap').text().split('(')[0],
                            abbv: cells.eq(1).attr('onclick').split('\'')[5]
                        },
                        home: {
                            name: cells.eq(2).find('.col-6.text-nowrap').text().split('(')[0],
                            abbv: cells.eq(2).attr('onclick').split('\'')[5]
                        },
                        game: {
